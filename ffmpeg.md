...
## 3. Basic Conversions and Information
...
*   **Without Re-encoding (fastest, preserves quality, but cut points may be imprecise to keyframes)**:
    ...
    # -ss [start_time] -i input.mp4 -t [duration] -c copy output.mp4
    ```
*   **With Re-encoding (precise cut points, allows codec changes)**:
    ...
    # -ss [start_time] -i input.mp4 -t [duration] -c:v libx264 -c:a aac -b:a 128k output.mp4
    ```
...
## 5. Image and Frame Manipulation
...
## 8. Advanced Filters & Specific Use Cases
